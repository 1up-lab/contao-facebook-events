...
class ModuleFacebookEvents extends \Module
{
    public function compile()
    {
        ...
        $calendars = $database->prepare("SELECT id, facebook_appid, facebook_secret, facebook_page, facebook_size, facebook_imagemargin, facebook_floating FROM tl_calendar WHERE facebook_synced = '1'")->execute();
